...
Welcome to `jupyter-utils` contributor's guide.
...
If you experience bugs or general issues with `jupyter-utils`, please have a look
...
You can help improve `jupyter-utils` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`jupyter-utils` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `jupyter-utils`'s files. While this mechanism can
...
```
conda create -n jupyter-utils python=3 six virtualenv pytest pytest-cov
conda activate jupyter-utils
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/jupyter-utils.git
   cd jupyter-utils
   ```
...
5. Install [pre-commit]:
   ...
   `jupyter-utils` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/jupyter-utils
[issue tracker]: https://github.com/<USERNAME>/jupyter-utils/issues
